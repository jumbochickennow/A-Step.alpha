/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=WorkerEnv` (hash: 73ef8e8e198b9e2fc34b10f907b03326)
// Runtime types generated with workerd@1.20260820.1 2026-08-29 nodejs_compat
interface __BaseEnv_WorkerEnv {
	...
	OUTBOUND_WEBHOOK_ALLOWED_HOSTS: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TURNSTILE_SECRET_KEY" | "TURNSTILE_ALLOWED_HOSTNAMES" | "ALLOWED_ORIGINS" | "PII_ENCRYPTION_KEY_V1" | "BLIND_INDEX_SECRET" | "SESSION_SECRET" | "ADMIN_PASSWORD" | "WEBHOOK_HMAC_SECRET" | "OUTBOUND_WEBHOOK_URL" | "OUTBOUND_WEBHOOK_ALLOWED_HOSTS" | "CF_ACCESS_TEAM_DOMAIN" | "CF_ACCESS_POLICY_AUD">> {}
}
