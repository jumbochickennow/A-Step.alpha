/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8309ec462e621f77dd118afe244d8d65)
// Runtime types generated with workerd@1.20260828.1 2026-08-29 nodejs_compat
interface __BaseEnv_Env {
	GUIDES_BUCKET: R2Bucket;
	OPPORTUNITY_IMAGES_BUCKET: R2Bucket;
	DB: D1Database;
	CONTACT_EMAIL: SendEmail;
	EVENT_QUEUE: Queue;
	ASSETS: Fetcher;
	GOOGLE_SHEETS_SPREADSHEET_ID: "12H3V0OC8ImOqFSHHWdra8GHrktC8u5xK6lzxFcUDd6c";
	TURNSTILE_SECRET_KEY: string;
	TURNSTILE_ALLOWED_HOSTNAMES: string;
	ALLOWED_ORIGINS: string;
	PII_ENCRYPTION_KEY_V1: string;
	BLIND_INDEX_SECRET: string;
	ADMIN_PASSWORD_HASH: string;
	ADMIN_PASSWORD_PEPPER: string;
	RESOURCE_REF_SECRET: string;
	GOOGLE_SHEETS_CLIENT_EMAIL: string;
	GOOGLE_SHEETS_PRIVATE_KEY: string;
	ADMIN_SECURITY: DurableObjectNamespace<import("./worker/index").AdminSecurityCoordinator>;
	RATE_LIMITER: DurableObjectNamespace<import("./worker/index").AtomicRateLimiter>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "AdminSecurityCoordinator" | "AtomicRateLimiter";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GOOGLE_SHEETS_SPREADSHEET_ID" | "TURNSTILE_SECRET_KEY" | "TURNSTILE_ALLOWED_HOSTNAMES" | "ALLOWED_ORIGINS" | "PII_ENCRYPTION_KEY_V1" | "BLIND_INDEX_SECRET" | "ADMIN_PASSWORD_HASH" | "ADMIN_PASSWORD_PEPPER" | "RESOURCE_REF_SECRET" | "GOOGLE_SHEETS_CLIENT_EMAIL" | "GOOGLE_SHEETS_PRIVATE_KEY">> {}
}
